...
* **Update du 27/01/25** : il reste encore 92 billets à transferer. Essentiellement dans la catégorie Motos. Je suis pas sûr de tenir la deadline que je m'étais fixé à fin janvier. Pendant le transfert, même si j'apporte quelques modifications aux billets, je ne vais pas modifier les dates de dernière mise à jour. Je ne le ferai que si, après le transfert, je reviens sur une page pour y ajouter des compléments ou la réécrire complètement. Les dates de première et de dernière édition se trouvent **en bas de chaque page**, tandis que **l'estimation du temps de lecture** est s'affiche en haut. Pour l'instant je suis focus sur le transfert.