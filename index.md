...
Le **13 janvier 2025** il reste **158 articles** à transférer (essentiellement dans les catégories C++ et Pilotage). J'espère avoir terminé fin janvier 2025. Je ne suis pas sûr de transférer tous les billets car certaines ne sont vraiment plus d'actualité. D'un autre côté, j'ai souvent été bien content de retrouver une info dans une "vieille" page qui était toujours en ligne... Lire par exemple le premier épisode de la série d'article sur [Simple OS]({%link docs/02_simple_os/000_sos_2_le_retour_20_ans_apres_episode_0/sos_2_le_retour_20_ans_apres_episode_0.md%}). Je ne sais pas, je vais voir...  
