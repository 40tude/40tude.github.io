...
<!-- reveal-md .\_slides_equa_diff_in_physics_01.md --watch -->

<style>
  .reveal { font-size: 28px; }
  .reveal h1 { font-size: 1.6em; line-height: 1.2; text-align: left; }
  ...
  .reveal .slides section { padding-top: 20px; }
  ...
  .reveal section.bumper h1,
  .reveal section.bumper h2 {
    text-align: center;
    width: 100%;
  }
</style>
...
Because these equations describe how a system's state evolves based on its current configuration
