...
A <a href="{%link docs/03_maths/020_equa_diff_in_physics/docs/index.html%}" target="_blank">slide deck</a> is available.
...
* [Gradient Descent in 1, 2 or N dimensions]({%link docs/09_ml_ai/002_gradient_descent/gradient_descent.md%})
