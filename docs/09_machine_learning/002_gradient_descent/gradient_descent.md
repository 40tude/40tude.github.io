...
***Yes, but no...I understand "error" but I do not understat why you introduce the "cost" and in addition, I do not understant why you decided to square the error. Can you come back on this point?***
...
Think of it like driving. The raw error is your distance from the center of the lane. The cost is like your stress level.
*   If you're 100 cm out of your lane, you're a little stressed (`cost = 1`).
*   If you're 1 cm out and heading into oncoming traffic, you're *panicked* (`cost = 100`)!
