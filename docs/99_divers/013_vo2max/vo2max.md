...
La VO2Max (pour “Volume d’Oxygène Maximal”) désigne la consommation maximale d’oxygène que le corps peut utiliser lors d’un effort physique intense. C’est une mesure ta capacité cardio-respiratoire et un indicateur de ton [endurance aérobie][1]. La VO2Max c'est la quantité maximale d’oxygène (exprimée en millilitres, faut 1000 millilitres pour faire un litre) que l’on peut consommer par minute et par kilogramme de poids corporel (ml/min/kg) lors d’un effort prolongé et intense. Plus cette valeur est élevée, plus le coureur est capable de maintenir un effort intense sur une [longue durée][2].

***Heu... J'ai rien compris aux unités. Tu peux revenir là-dessus?*** Si c'est pas clair, t'as raison de m'arrêter tout de suite. On a dit consommation d'oxygène par minute et par kilogramme de poids corporel (ml/min/kg). L'oxygène tu vois ce que c'est? Ben si, quand même... C'est un gaz ($$0_2$$) qui occupe un certain volume et les volumes s'expriment normalement en metre cube (1m par 1m par 1m). Bon, mais cette unité est un peu trop grande si on la compare à nos poumons, au nombre de litres de sang qu'on a dans le corps etc. Donc on va utiliser des millilitres pour exprimer le volume d'oxygène. OK, ça normalement c'est bon.

Maintenant, on veut voir combien tu consommes d'oxygène par minute. C'est ça le truc qui est le plus important. OK... Du coup quand tu vas dans un centre médical pour sportifs, on te met un masque sur la tronche avec une entrée et une sortie d'air, tu monte sur un tapis et tu courre en suivant les instructions qu'on va te donner. Là, du coup, on est capable de tout mesurer et plus tu va consommer d'oxygène plus ton score va augmenter. Imagine je courre et je consomme 100 litres en 10 minute (ici on se fiche des unités, c'est juste pour fixer les idées). Du coup je consomme 10l/min. Toi tu arrives et tu consomme 20l/min. Du coup, ton score est 2 fois meilleur que le mien.  
...
Mouai... C'est bien mais c'est pas top. En effet, j'ai 10 ans et des barbelés plein les dents. Toi t'as 22 ans... Du coup la comparaison est pas trop équitable car t'es beaucoup plus musclé que moi et du coup on comprend bien que ta "machine" va consommer beaucoup plus que la mienne. Afin de pouvoir comparer des pommes avec des pommes on a décidé de prendre la valeur précédente et de la diviser par le poids du sportif. Dans notre exemple je pèse 30 kg tout mouillé et toi 75 kg. Du coup nos score deviennent 0.33 et 0.26 et du coup "bouboule", mon score est meilleur que le tiens.

Bon, maintenant oublies les unités de mes exemples mais garde en tête qu'on prend le volume d'oxygène que tu as consommé pendant une minute et qu'on a divisé tout ça par ton poids.


### Physiologie 
La VO2Max reflète les limites de ton moteur aérobie. Sur le plan physiologique, elle dépend à la fois de la capacité du cœur et des poumons à acheminer l’oxygène vers les muscles, et de la capacité de tes muscles à extraire et utiliser cet oxygène pour produire de l’énergie. On peut modéliser cela par [le principe de Fick](https://en.wikipedia.org/wiki/Fick_principle) :

$$VO_2 = Q *(C_aO_2 - C_vO_2)$$

où $$Q$$ est le débit cardiaque (volume de sang pompé par le cœur par minute), $$C_aO_2$$ la teneur en oxygène du sang artériel et $$C_vO_2$$ celle du sang veineux. En d’autres termes, une VO2Max élevée implique à la fois un cœur puissant capable d’éjecter un grand volume de sang oxygéné, et des muscles entraînés dotés d’une riche vascularisation et de nombreuses mitochondries pour utiliser cet oxygène. La VO2Max représente ainsi le “plafond” de vos capacités aérobies – on la compare souvent à la taille du moteur d’une voiture pour un athlète d’endurance.

***Le moteur d'une voiture. T'es sûr?*** Imagine le moteur d'une voiture. La VO2Max, c'est la cylindrée (exprimée en $$cm^3$$) du moteur. Elle représente ta puissance aérobie brute. Un moteur avec une plus grande cylindrée peut potentiellement produire plus de puissance et aller plus vite. Bien sûr si tu compare 1.6L d'un moteur de F1 à celui de ta Citroën C5 Aircross... Y a pas photo... Y a un des moteur qui est affûté et l'autre... Y a encore un peu de boulot et pas mal de poids à perdre.

### Rôle en course à pied. 
En course à pied, la VO2Max est un atout majeur car elle constitue en quelque sorte le **potentiel aérobique maximal** d’un coureur. Un coureur avec une VO2Max élevée dispose d’une grande "réserve" d’oxygène à exploiter, ce qui favorise des allures soutenues sur la durée. En effet, chez les athlètes d’endurance, la VO2Max est corrélée à la performance sur des distances allant du 5 km au marathon – certaines études estiment qu’elle peut expliquer à elle seule jusqu’à ~50 % de la performance sur semi-marathon ou marathon. Ceci étant, il est important de noter que ce n’est pas le seul facteur de la performance en [course à pied][2]([lien][5]). Des coureurs ayant une VO2Max un peu plus faible peuvent parfois battre des coureurs à VO2Max plus élevée, grâce à d’autres déterminants essentiels : l’économie de course (efficacité technique), le seuil lactique (capacités à maintenir un pourcentage élevé de VO2Max sans accumuler trop de lactate), la stratégie de course, etc. La VO2Max fixe le “potentiel maximal” de votre moteur aérobie, mais la performance réelle dépend aussi de la part de ce potentiel que vous pouvez exploiter durablement et de votre technique.

### Mesure de la VO2Max
La mesure directe de la VO2Max se fait en laboratoire lors d’un test d’effort maximal, généralement sur tapis roulant. Le coureur porte un masque relié à un analyseur de gaz qui mesure précisément l’oxygène consommé et le gaz carbonique expiré à mesure que l’effort augmente jusqu’à l’épuisement. Le point où la consommation d’oxygène ne parvient plus à augmenter malgré l’augmentation de l’intensité correspond à la VO2Max. Ce protocole étant contraignant (matériel coûteux, effort maximal en laboratoire), on utilise souvent des tests indirects ou des estimations terrain pour approcher la VO2Max.
...
* **Génétique** : Compte pour environ 20 à 30%. Là c'est mort, on peut rien faire.
* **L'âge** : Elle atteint son pic vers 20-30 ans et décline ensuite lentement. Tisane de tisane... On peut rien faire non plus.
* **Le sexe** : En moyenne, les hommes ont une VO2Max 10 à 20% plus élevée que les femmes. Ah quand même, va nous rester kekchose! Non mais, qui c'est qui pisse debout 😁. Mais bon, trêve de plaisanterie, on peut pas changer grand chose (commencer pas à me chauffer sur le sujet ou je vais chercher tonton Trump)
* **L'entraînement** : Enfin! C'est **LE** facteur sur lequel on peut agir le plus. Il se dit qu'un entraînement structuré peut l'augmenter de 15 à 20%, voire plus.
...
Évidement, ta montre ignore complètement la quantité réelle d’oxygène que tu consommes, puisqu’elle ne fait que déduire un VO2 à partir de la corrélation cardiaque/allure. Il y a donc une marge d’erreur inévitable. 

D’après Firstbeat (la société à l’origine de l’algorithme), si toutes les données sont de bonne qualité, la VO2Max estimée peut être à ~95 % proche de la valeur réelle, avec une erreur typique de l’ordre de ±3,5 ml/kg/min ([lien][9]). 

Autrement dit, l’algorithme est assez impressionnant de fiabilité pour un usage terrain. Néanmoins, plusieurs facteurs peuvent dégrader la précision : une mesure de fréquence cardiaque erronée (capteur optique mal positionné, latence, etc.), un mauvais calibrage des zones de FC, un terrain vallonné ou un vent fort (qui faussent la relation allure/effort), ou encore un état de fatigue/échauffement inhabituel le jour de la sortie.

En pratique, l’intérêt principal de l’estimation VO2Max sur montre est de **suivre l’évolution** dans le temps plutôt que la [valeur absolue][2]. Si ta VO2Max "montre" passe de 45 à 48 ml/kg/min au fil des mois, il y a de fortes chances que ta condition physique aérobie se soit réellement améliorée – même si la valeur en elle-même reste une approximation. 

Inversement, une baisse graduelle peut révéler un creux de forme, du surmenage ou l’effet de l’âge. 

Il convient donc de surveiller la tendance, tout en gardant du recul : faut se calmer suite à une légère fluctuation (à la hausse ou à la baisse) et ne pas baser pas toute sa préparation sur ce seul [chiffre][2]. 

Pour une mesure scientifique et individualisée, y a pas photo, un test en laboratoire restera la référence.

En résumé, l’estimation de VO2Max fournie par ta Garmin est un outil pratique et relativement fiable pour le coureur amateur, à condition de l’utiliser correctement (bonnes données d’entrée, respect des conditions de mesure) et d’en comprendre les limites. Elle donne une idée de ton niveau d’endurance aérobie et de son évolution, sans toutefois remplacer un véritable test d’effort.
...
Bonne nouvelle : il est possible d’augmenter sa VO2Max grâce à l’entraînement, en particulier lorsque l’on débute ou que l’on n’a pas encore exploité pleinement son potentiel. Toutefois, les gains ne sont ni illimités ni uniformes selon les individus. 

On l'a dit, la VO2Max a une composante génétique et tend à plafonner à un niveau propre à chacun, malgré l’entraînement. De plus, elle diminue graduellement avec l’âge (environ 1% par an à partir de ~25 ans si l’on ne fait rien pour contrer ce déclin). 
...
Faut donc utiliser ces tables comme une référence générale pour se situer, mais faut pas être obsédé par ce chiffre. L'objectif est de voir une **évolution** dans le temps, se sentir mieux et en meilleure santé.
...
La VO2Max est un outil et non une fin en soi : c’est un baromètre de ta capacité respiratoire et cardiovasculaire. Améliore-la autant que possible par un entraînement intelligent, mais n’oublie pas qu’elle s’inscrit dans un ensemble plus large de qualités (vitesse, endurance spécifique, technique) à développer pour exceller en course à pied. 


PS : 
Y a pas mal de liens dans ce billet. Faut pas hésiter à prendre un peu de temps et de les lire. Notamment les guides et études sur la [VO2Max][4]([lien][9]), les articles de fond en français sur l’entraînement fractionné et la VMA, ou encore les tableaux de classification de la VO2Max par âge ([Cooper Institute][34]). 
