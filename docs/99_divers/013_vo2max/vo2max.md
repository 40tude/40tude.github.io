...
***Heu... J'ai rien compris aux unités. Tu peux revenir là-dessus?*** Si c'est pas clair, t'as raison de m'arrêter tout de suite. On a dit consommation d'oxygène par minute et par kilogramme de poids corporel (ml/min/kg). L'oxygène tu vois ce que c'est. Ben si quand même... C'est un gaz qui occupe un certain volume et les volumes s'expriment normalement en metre cube (1m par 1m par 1m). Bon mais cette unité est un peu trop grande si on la compare à nos poumons, le nombre de litres de sang qu'on a dans le corps etc. Donc on va utiliser des litres pour exprimer le volume d'oxygène. OK, ça normalement c'est bon.

Maintenant, on veut voir combien tu consommes d'oxygène par minute. C'est ça le truc qui est le plus important. OK... Du coup quand tu va dans un centre médical pour sportif, on te met un masque sur la tronche avec une entrée et une sortie d'air, tu monte sur un tapis et tu courre comme. Là du coup on est capable de tout mesurer et plus tu va consommer d'oxygène plus ton score va augmenter. Imagine je courre et je consomme 100 litres en 10 minute (ici on se fiche des unités, c'est juste pour fixer les idées). Du coup je consomme 10l/min. Toi tu arrives et tu consomme 20l/min. Du coup, ton score est 2 fois meilleur que le mien.  
