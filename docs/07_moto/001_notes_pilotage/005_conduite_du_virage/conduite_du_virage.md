...
* Être capable d'appliquer la **Throttle Rule** dans les virages (voir la [Note de Pilotage N° 01](https://www.40tude.fr/pilotage-moto-01-decouverte-de-la-piste/))

* Car c'est la confirmation qu'on est sur notre ligne idéale

* On s'occupe du point de sortie (PS) mais pas vraiment de la façon dont on redresse la moto en sortie (on verra ça un peu plus tard... [Note de Pilotage N° 06](https://www.40tude.fr/pilotage-moto-06-contre-braquage-en-sortie-de-virage/))
...
<!-- https://youtu.be/jX1VhUhMrtg?t=58 -->
<div align="center">
...
<div align="center">
<img src="./assets/image-37.webp" alt="" loading="lazy"/>
</div>
...
<!-- https://youtu.be/VFZoZLMZGqQ?t=376 -->
<div align="center">
...
* Je rappelle que l'idée ici c'est de ne **PAS** faire de freinage sur l'angle (enfin, [pas encore](https://www.40tude.fr/pilotage-moto-09-freinage-sur-langle-trail-breaking/) 😁)
...
Tout ceci fait partie du **Three Steps** dont on a déjà parlé dans la [note de Pilotage N°2](https://www.40tude.fr/pilotage-moto-02-three-steps/).
...
<div align="center">
<img src="./assets/image-31.webp" alt="" loading="lazy"/>
</div>
...
***In any fast-entry turn, calculate
the roll-off as carefully as you would a roll-on***
...
Si on rallume les
gaz trop tôt on a une trajectoire en Arc

Une fois que la moto
est sur l'angle c'est l'arrière qui est responsable de la stabilité
...
Quand on a terminé
avec le freinage et **avant** qu'on commence
à tourner la poignée des gaz
...
<div align="center">
<iframe width="560" height="315" src="https://youtu.be/f1NR1VdvmTA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
