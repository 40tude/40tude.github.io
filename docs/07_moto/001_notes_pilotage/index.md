...
**Si vous n'avez jamais mis les pieds sur un circuit** je vous propose plutôt de commencer par de lire ce [billet]({%link docs/07_moto/000_premiere_fois_sur_circuit/premiere_fois_sur_circuit.md%}) qui parle spécifiquement de ce sujet et qui va vous aider à organiser au mieux votre [première journée sur circuit]({%link docs/07_moto/000_premiere_fois_sur_circuit/premiere_fois_sur_circuit.md%}).
