...
| 10 | Faut toujours se [cacher derrière la bulle]({%link docs/07_moto/001_notes_pilotage/001_decouverte_de_la_piste_1/decouverte_de_la_piste_1.md%}). Sauf au freinage (effet de voile). On sort comme un diable au freinage |
...
| 23 | Faut être "progressif" quand on accélère. Ce n'est pas 0/1. |
...
| 25 | Sur un 1000 on ne fait pas des "U lines" mais de "V lines" (je ne suis pas sûr d'avoir compris). |
...
| 5 | [Pas agressif sur l'accélérateur]({%link docs/07_moto/001_notes_pilotage/005_conduite_du_virage/conduite_du_virage.md%}) surtout en sortie de virage. Pas on/off. Si on a été agressif, arriver plus vite au prochain tour et être plus doux/progressif en sortie sur l'accélérateur |
