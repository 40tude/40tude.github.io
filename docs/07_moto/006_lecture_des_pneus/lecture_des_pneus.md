...
L'idée est qu'à l'instar de l'indien qui lit les traces qu'ont laissé les bisons dans la prairie, ce qui est inscrit sur le pneu nous dit quelque chose.
...
<img src="./assets/image-14.webp"
    alt="Empreinte de bison"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Empreinte de bison</figcaption>
</figure>
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-7-1.webp"
    alt="Réglage de la précontrainte sur amortisseur arrière"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
...
<img src="./assets/image-6.webp"
    alt="Témoin d'usure sur pneu moto"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Témoin d'usure sur pneu moto</figcaption>
</figure>
...
<img src="./assets/image-4.webp"
    alt="Un autre témoin d'usure sur pneu moto"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Un autre témoin d'usure sur pneu moto</figcaption>
</figure>


<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-10.webp"
    alt="Un dernier témoin d'usure sur pneu moto"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Un dernier témoin d'usure sur pneu moto</figcaption>
</figure>
...
<img src="./assets/image-15.webp"
    alt="Le N° DOT et son format WWYY"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Le N° DOT et son format WWYY</figcaption>
</figure>
...
* Une fois qu'on a en tête l'image de l'aiguille qui rentre dans un tube on comprend mieux les expressions "ouvrir la détente" et "ouvrir la compression". Cela veut juste dire qu'il faut tout dévisser (sens trigonométrique, anti-horaire) afin que le débit d'huile soit maximum.
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-2-3.webp"
    alt="Positions des différents réglages de la fourche du RSV4"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Positions des différents réglages de la fourche du RSV4</figcaption>
</figure>
...
<img src="./assets/image-2.webp"
    alt="Les réglages piste de la fourche du RSV4"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Les réglages piste de la fourche du RSV4</figcaption>
</figure>
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-7-scaled.webp"
    alt="Clé de la trousse à outils du RSV4"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Clé de la trousse à outils du RSV4</figcaption>
</figure>
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-6_1.webp"
    alt="Clé de réglage de la précontrainte"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Clé de réglage de la précontrainte</figcaption>
</figure>
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-6-7.webp"
    alt="L'état de surface du pneu qu'on cherche à obtenir"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>L'état de surface du pneu qu'on cherche à obtenir</figcaption>
</figure>
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-6-8.webp"
    alt="Exemple d'état de pneu qu'on cherche à obtenir"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Exemple d'état de pneu qu'on cherche à obtenir</figcaption>
</figure>
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-6-9.webp"
    alt="Un autre exemple d'état de pneu qu'on cherche à obtenir"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Un autre exemple d'état de pneu qu'on cherche à obtenir</figcaption>
</figure>
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-6-10.webp"
    alt="Dans le losange, l'état de pneu qu'on cherche à obtenir"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Dans le losange, l'état de pneu qu'on cherche à obtenir</figcaption>
</figure>
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-6-11.webp"
    alt="L'état de pneu qu'on cherche à obtenir se trouve à droite"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>L'état de pneu qu'on cherche à obtenir se trouve à droite</figcaption>
</figure>
...
Ne commence pas à râler, c'est juste une division, ça reste gérable...

$$K$$ est une constante. Prends la valeur 100 si tu veux. Maintenant, si la température $$T$$ du pneu augmente (à cause des frottements avec la piste par exemple), comme le volume $$V$$ du pneu ne change pas (ou presque) alors la pression $$P$$ doit augmenter. Au pire, dans l'équation précédente si tu multiplies la température $$T$$ par deux, afin que la division donne toujours le même résultat $$K$$, tu dois multiplier par la pression $$P$$ par deux aussi.
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-7.webp"
    alt="Exemple de pneu bleu (iridescence)"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Exemple de pneu bleu (iridescence)</figcaption>
</figure>
...
<img src="./assets/image-11.webp"
    alt="Analyse de la hauteur des rainures du pneu moto sur l'angle ou verticale"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Analyse de la hauteur des rainures du pneu moto sur l'angle ou verticale</figcaption>
</figure>


Ci-dessous, le pneu arrière avance quand il va vers la gauche.

<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-3-1-scaled.webp"
    alt="Analyse de la hauteur des rainures du pneu"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Analyse de la hauteur des rainures du pneu</figcaption>
</figure>
...
<img src="./assets/image-13.webp"
    alt="Il faut régler en premier le problème de la moto sur l'angle"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Il faut régler en premier le problème de la moto sur l'angle</figcaption>
</figure>
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-2-2.webp"
    alt="Pression trop basse. Accumulation de billes sur l'avant des rainures du pneu AV."
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Pression trop basse. Accumulation de billes sur l'avant des rainures du pneu AV.</figcaption>
</figure>
...
<img src="./assets/image.webp"
    alt="Exemple de pneu qui ne monte pas en température."
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Exemple de pneu qui ne monte pas en température.</figcaption>
</figure>
...
<img src="./assets/image-1-1.webp"
    alt="Un autre exemple de pneu qui ne monte pas uniformément en température."
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Un autre exemple de pneu qui ne monte pas uniformément en température.</figcaption>
</figure>
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-2-1.webp"
    alt="Exemple de pneu qui monte trop haut en température."
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Exemple de pneu qui monte trop haut en température.</figcaption>
</figure>
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-6-6.webp"
    alt="Fourche et amortisseur démontés prêts à être envoyé en révision."
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Fourche et amortisseur démontés prêts à être envoyé en révision.</figcaption>
</figure>



3. Je prends le temps de régler mes suspensions en statique et de noter mes réglages. Voir la section [Références](#références) un peu plus bas. Pensez à bien **tout ouvrir** (compression, détente etc.) quand vous vérifiez les courses mortes.
4. Sur la fourche je mets un Rilsan. Cela permettra de vérifier si la fourche travaille sur une amplitude maximale et/ou si elle n'arrive pas en butée. C'est alors **très dangereux** car en butée il n'y a plus d'amortissement à part ce que peut fournir la déformation du pneu. Mais bon, cela ne va pas très loin, on croise rapidement l'avant et on termine au tas bêtement. C'est beaucoup moins pratique à faire mais j'essaie aussi de mettre aussi un Rilsan sur l'amortisseur.

Voir le Rilsan sur le fourreau. Quand la fourche va s'enfoncer, il va encore descendre.


<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-6-3.webp"
    alt="Rilsan sur tube de fourche pour mesurer l'enfoncement de la fourche"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Rilsan sur tube de fourche pour mesurer l'enfoncement de la fourche</figcaption>
</figure>
...
<figure style="max-width: 600px; margin: auto; text-align: center;">
<img src="./assets/image-6-5.webp"
    alt="Un autre exemple de Rilsan sur tube de fourche"
    style="width: 100%; height: auto;"
    loading="lazy"
/>
<figcaption>Un autre exemple de Rilsan sur tube de fourche</figcaption>
</figure>
...
* À $$t$$ moins 10 min de la premiere session de l'après-midi, dans tous les cas, je vérifie les pressions. Voir les modalités au premier point.
...
<img src="./assets/image-2_2022_10.webp"
    ...
    loading="lazy"
/>
<figcaption>Thermomètre laser</figcaption>
</figure>
...
<img src="./assets/image-3.webp"
    ...
    loading="lazy"
/>
<figcaption>Manomètre de précision et thermomètre Prisma</figcaption>
</figure>
...
<img src="./assets/image-6-4.webp"
    ...
    loading="lazy"
/>
<figcaption>Dave Moss en pleine séance d'explication</figcaption>
</figure>
...
<div style="position: relative; padding-bottom: 56.25%; height: 0;">
    <iframe
    src="https://www.youtube.com/embed/0mGDdnFGyZ0?start=13"
    title="I'm a legend"
...
<div style="position: relative; padding-bottom: 56.25%; height: 0;">
    <iframe
    src="https://www.youtube.com/embed/lo0kv_6hG-0?start=22"
    title="Les explications de MotoJitsu à propos des suspensions"
    style="position: absolute; inset: 0; width: 100%; height: 100%;"
    allowfullscreen>
    </iframe>
</div>
...
<div style="position: relative; padding-bottom: 56.25%; height: 0;">
    <iframe
    src="https://www.youtube.com/embed/Cqq5dEiADJY?start=0"
    title="Les explications de Dan Netting à propos de la lecture des pneus sur piste"
    style="position: absolute; inset: 0; width: 100%; height: 100%;"
    allowfullscreen>
    </iframe>
</div>
...
<img src="./assets/image-6_2022_10.webp"
    ...
    loading="lazy"
/>
<figcaption>Le livre Race Tech's Motorcycle Suspension Bible</figcaption>
</figure>
...
<img src="./assets/image-16.webp"
    ...
    loading="lazy"
/>
<figcaption>Les 2 tomes de Le chrono ne ment pas de Steven Casaer</figcaption>
</figure>
...
<img src="./assets/image-6-1.webp"
    ...
    loading="lazy"
/>
<figcaption>Le livre Total Control de Lee Parks</figcaption>
</figure>
