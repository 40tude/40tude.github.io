...
description: "A gentle introduction to SOLID principles using Rust. Here we focus is on Open-Closed Principle."
parent: "Rust"
nav_order: 31
...
A gentle introduction to SOLID principles using Rust. Here we focus is on Open-Closed Principle.
{: .lead }
